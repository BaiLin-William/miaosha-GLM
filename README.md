...
**当前版本：v1.4.1。** 秒杀网站的防护策略持续升级，本项目的成功率也在动态变化。我们非常欢迎社区贡献代码、反馈问题、分享经验。
...
1. 下载 zip 压缩包：[miaosha-GLM.zip](https://github.com/Rocke1001feller/miaosha-GLM/releases/download/v1.4.1/miaosha-glm-1.4.1-chrome.zip)
...
**macOS**
- 双击 `miaosha-glm-1.4.1-chrome.zip`，系统自动解压
- 或右键选择「用归档实用工具打开」
...
**Linux**
```bash
unzip miaosha-glm-1.4.1-chrome.zip
```
